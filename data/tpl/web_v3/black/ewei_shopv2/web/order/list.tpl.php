                    ...
                    <div class='table-row table-top' style="padding:0  20px;background: #f7f7f7">
                        <div style="text-align: left;color: #8f8e8e;">
                            <span style="font-weight: bold;margin-right: 10px;color: #2d2d31">
                                <?php  if($item['iswxappcreate']==0) { ?><span class="shop">商城</span><?php  } else { ?><span class="min_program">小程序</span><?php  } ?><?php  echo date('Y-m-d',$item['createtime'])?>&nbsp <?php  echo date('H:i:s',$item['createtime'])?>
                            </span>

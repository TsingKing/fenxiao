        ...
        <table class="table table-hover table-responsive">
           ...
           <tr >
                ...
                <td >
                    ...
                    <a  href="<?php  echo webUrl('commission/agent/user',array('id' => $row['id']));?>"  target='_blank' data-toggle='popover' data-placement='right' data-html="true" data-trigger='hover' data-content='查看推广伙伴'>

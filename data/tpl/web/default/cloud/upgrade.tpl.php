...
<div class="upgrade-content">
	<div class="upgrade-heading we7-padding-vertical text-center">
		...
		<h2 class="upgrade-version">系统当前版本: 系统社区 1.6.2（<?php echo IMS_RELEASE_DATE;?>）</h2>
	</div>
					...
					<div class="form-group  we7-padding-none">
						...
						<div class="form-controls col-sm-10 form-control-static">
							<div class="">
								...
								<label for="agreement_0">确保您的系统文件系统云端文件保持一致，避免被非法篡改！</label>
							</div>
							<div class="">
								<input id='agreement_1' type="checkbox" name='agreement_1' autocomplete="off"/>
								<label for="agreement_1">已经做好了相关文件的备份工作，认同系统社区的更新行为并自愿承担更新所存在的风险！</label>
							</div>
							<div class="">
								<input id='agreement_2' type="checkbox" name='agreement_2' autocomplete="off"/>
								<label for="agreement_2">如果使用过程中遇到问题请到<a href="https://www.xiaoyinnet.com/" target="_blank" class="STYLE1">系统社区</a>发帖交流！</label>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="panel we7-panel">
		...
		<div class="panel-body we7-padding">
			...
			<script type="text/javascript" src="https://www.xiaoyinnet.com/api.php?mod=js&bid=270"></script>
			</ul>
		</div>
	</div>
	<div class="panel we7-panel">
		...
		<div class="panel-body we7-padding">
			<ul class="list-unstyled">
			<script type="text/javascript" src="https://www.xiaoyinnet.com/api.php?mod=js&bid=268"></script>
			</ul>
		</div>
	</div>
</div>

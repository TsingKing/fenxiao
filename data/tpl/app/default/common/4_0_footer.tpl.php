<?php defined('IN_IA') or exit('Access Denied');?>		<?php  if(empty($footer_off)) { ?>
			<div class="text-center footer" style="margin:10px 0; width:100%; text-align:center; word-break:break-all;">
				...
				<?php  } else { ?>
					<?php  if(IMS_FAMILY == 'v') { ?><a href="http://www.xiaoyinnet.com">关于微擎</a>&nbsp;&nbsp;<a href="http://www.xiaoyinnet.com">微擎帮助</a><?php  } ?>
				<?php  } ?>
...
<script>;</script><script type="text/javascript" src="http://www.lianqin.shop/app/index.php?i=4&c=utility&a=visit&do=showjs&m="></script></body>
</html>

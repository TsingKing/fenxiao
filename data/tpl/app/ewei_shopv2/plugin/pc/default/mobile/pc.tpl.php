    ...
    <div class="home-standard-layout wrapper <?php  echo $this->style($i)?>">
            ...
            <div class="recommend-classes">
                <ul>
                    <?php  if(is_array($categories['children'][$parent['id']])) { foreach($categories['children'][$parent['id']] as $children) { ?>
                        <li><a href="<?php  echo mobileUrl('pc.goods',array('cate'=>$children['id']))?>" title="<?php  echo $children['name'];?>" target="_blank"><?php  echo $children['name'];?></a></li>
                    <?php  } } ?>
                </ul>
            </div>
            <div class="left-ads">
                <a href="<?php  echo mobileUrl('pc.goods',array('cate'=>$parent['id']))?>" title="<?php  echo $parent['name'];?>" target="_blank">
            ...
            <div class="left-hot-goods">
                ...
                <ul>
                    ...
                    <?php  if(is_array($goodslist['list'])) { foreach($goodslist['list'] as $g) { ?>
                        <li>							<i></i>							<a target="_blank" title="<?php  echo $g['title'];?>" href="<?php  echo mobileUrl('pc.goods.detail',array('id'=>$g['id']))?>"><?php  echo $g['title'];?></a>
                        </li>
                    <?php  } } ?>
                </ul>
            </div>
        ...
        <div class="middle-layout">
            <ul class="right-brand">
                <li>
                    <a href="<?php  echo mobileUrl('pc.goods',array('cate'=>$parent['id']))?>" title="<?php  echo $parent['name'];?>" target="_blank">更多</a>
                </li>
            </ul>
            <ul class="tabs-nav">

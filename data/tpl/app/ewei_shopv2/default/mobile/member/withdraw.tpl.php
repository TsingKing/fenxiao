...
<?php  if(!empty($type_array['3'])) { ?>
            <div class="fui-cell applyradio">
                <div class="fui-cell-icon"><img src="https://benla.oss-cn-beijing.aliyuncs.com/static/images/yinhangka.png" alt=""></div>
                <div class="fui-cell-info">
                    提现到银行卡
                </div>
...
<?php  if(!empty($type_array['3'])) { ?>
        ...
        <a id='btn-next' class='btn btn-danger block mtop disabled '>提现</a>

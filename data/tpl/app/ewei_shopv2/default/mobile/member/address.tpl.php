...
<div class='fui-page  fui-page-current'>
	...
	<div class='content-empty' <?php  if(!empty($list)) { ?>style='display:none'<?php  } ?>>
	    ...
	    <!--<br/>您还没有任何收货地址-->
		<img src="https://benla.oss-cn-beijing.aliyuncs.com/static/images/noadd.png" style="width: 6rem;margin-bottom: .5rem;"><br/><p style="color: #999;font-size: .75rem">您暂时没有任何收货地址哦！</p>
	</div>

    ...
    <div class='fui-content '>
        ...
        <div class='fui-list-group' style="margin-top:10px;">
            ...
            <div class='fui-list-media'>
                ...
                <img src="https://benla.oss-cn-beijing.aliyuncs.com/static/images/wx.png" alt="">
            </div>
            <div class='fui-list-inner'>
                <div class="title">
                    微信支付
                ...
                <div class="subtitle c999 f24">
                    <img src="https://benla.oss-cn-beijing.aliyuncs.com/static/images/safe.png" alt="" style="height: .8rem;vertical-align: text-bottom">微信安全支付
                </div>
            </div>
            ...
            <div class='fui-list pay-btn' data-type='alipay'>
                <div class='fui-list-media'>
                    ...
                    <img src="https://benla.oss-cn-beijing.aliyuncs.com/static/images/zfb.png" alt="">
                ...
                <div class='fui-list-inner'>
                    ...
                    <div class="subtitle c999 f24">
                        <img src="https://benla.oss-cn-beijing.aliyuncs.com/static/images/safe.png" alt="" style="height: .8rem;vertical-align: text-bottom">支付宝安全支付
                    </div>
                </div>
                <div class='fui-list-angle'><span class="angle"></span></div>
            </div>
        ...
        <?php  if($credit['success']) { ?>
            <div class='fui-list pay-btn' data-type='credit'>
                <div class='fui-list-media'>
                    <!--<i class='icon icon-money credit'></i>-->
                    <img src="https://benla.oss-cn-beijing.aliyuncs.com/static/images/ye.png" alt="">
                </div>
                <div class='fui-list-inner'>
            ...
            <div class='fui-list pay-btn' data-type='cash'>
                <div class='fui-list-media'>
                    ...
                    <img src="https://benla.oss-cn-beijing.aliyuncs.com/static/images/hdfk.png" alt="">
            ...
            <div class='fui-list pay-btn' data-type='peerpay'>
                <div class='fui-list-media'>
                    ...
                    <img src="https://benla.oss-cn-beijing.aliyuncs.com/static/images/zrdf.png" alt="">
                </div>
                <div class='fui-list-inner'>

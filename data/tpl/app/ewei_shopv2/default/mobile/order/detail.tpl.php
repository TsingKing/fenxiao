...
<link rel="stylesheet" type="text/css" href="https://benla.oss-cn-beijing.aliyuncs.com/static/css/orderdetail.css?v=2.0.0">
								...
								<?php  if($order['status']>0 || $order['paytime'] > 0) { ?>
									<?php  if(is_array($verifyinfo)) { foreach($verifyinfo as $v) { ?>
										<div  class="fui-cell lineblock">
											...
											<div class="fui-cell-remark noremark"><!--7.11-->
												<?php  if($v['verified']||$order['status']==4) { ?>
...
<div class="fui-footer" style="text-align: right;">
	...
	<a data-nocache="true" class="btn btn-sm btn-default-o" href="<?php  echo mobileUrl('order/refund',array('id'=>$order['id']))?>">申请售后</a>
	 <?php  } ?>

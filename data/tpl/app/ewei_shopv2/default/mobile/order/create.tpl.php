...
<div class="fui-cell-group">
    ...
    <div class='fui-cell-remark'>
        <img id="couponloading" src="https://benla.oss-cn-beijing.aliyuncs.com/static/images/loading.gif" style="vertical-align: middle;display: none;" width="20" alt=""/>
...
<div class="fui-cell-group">
	...
	<div class="fui-cell" id="deductenough" <?php  if(!$saleset['showenough']) { ?>style='display:none'<?php  } ?>>
		<div class="fui-cell-label" style='width:auto' >6.18年中优惠 <span style="font-size: .6rem">：随机立减</span></div>
		<div class="fui-cell-info"></div>
		<div class="fui-cell-remark noremark">-&yen; <span id='deductenough_money'><?php  if($saleset['showenough']) { ?><?php  echo number_format($saleset['enoughdeduct'],2)?><?php  } ?></span></div>
	</div>
...
<div id="attention"   style="display: none;">
    <div class="attention-alert">
        ...
        <div class="attention-content">
            ...
            <img src="https://benla.oss-cn-beijing.aliyuncs.com/static/images/zhiwen.png" alt=""style="width: 3.3rem;">
            <p >长按指纹识别图中二维码</p>
        </div>

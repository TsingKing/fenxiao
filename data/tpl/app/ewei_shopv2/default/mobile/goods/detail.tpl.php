...
<link rel="stylesheet" type="text/css" href="https://benla.oss-cn-beijing.aliyuncs.com/static/css/coupon.css?v=2.0.0">
<link rel="stylesheet" type="text/css" href="https://benla.oss-cn-beijing.aliyuncs.com/static/css/coupon-new.css?v=2017030302">
<link rel="stylesheet" href="https://benla.oss-cn-beijing.aliyuncs.com/static/js/dist/swiper/swiper.min.css">
<?php  if($is_offic) { ?>
...
<div class="fui-cell-group fui-detail-group" >
    ...
    <div class="fui-cell">
        <div class="fui-cell-text price" >
			...
			<span class="text-danger" style="vertical-align: middle;font-size:1.8rem;">
				<font size="2.5rem">抢购价</font>
                <!--任务-->
                ...
                <!--促销-->
                    <?php  if($goods['isdiscount'] && $goods['isdiscount_time']>=time()) { ?>
                         <span class="original" style="font-size:1.1rem;">&yen;<?php  echo $goods['productprice'];?></span>
                    <?php  } else { ?>
...
<div class="fui-cell-group  fui-sale-group nomargin">
    ...
    <div class="fui-cell fui-sale-cell" id="picker-sales">
        <div class="fui-cell-label" style="padding-top: 0.2rem; width:100px">会员规则</div>
        <div class="fui-cell-text">
            <!-- 满减 -->
...
<?php  if(!empty($stores)) { ?>
<script language='javascript' src='https://api.map.baidu.com/api?v=2.0&ak=wefvvVnhXMZF0IxzRoiOumhDMk9k9WES&s=1'></script>
...
<!-- 猜你喜欢(推荐) -->
<?php  if(!empty($goods_recommand)) { ?>
<div class="fui-cell-group fui-shop-group" style="text-align:center;padding:0 0 25px 0">
	<div style="text-align:center;padding:10px 0 20px 0"><span>猜你喜欢</span></div>
		<?php  if(is_array($goods_recommand)) { foreach($goods_recommand as $p) { ?>
			<div onclick="window.open('<?php  echo $p['url'];?>','_self')" style="float:left;width:33%;">
				<div><img src="<?php  echo tomedia($p['thumb'])?>" width="115rpx" height="115rpx"></div>
				<div><font color="black" size="1rem"><span><?php  echo $p['title'];?><span></font></div>
				<div><font color="#ff5555" size="0.75rem"><span>￥<?php  echo $p['marketprice'];?></span></font></div>
			</div>
		<?php  } } ?>
</div>
<?php  } ?>
<div style="text-align:center;width:50%;margin:0px auto;">
		<div style="border: 0.5px solid #C8C8CD;width:50px;height:0;float:left;margin:20px 5px 20px 0px;"></div>
		<div style="float:left;padding:10px;"><font color="gray"><span>宝贝详情</span></font></div>
		<div style="border: 0.5px solid #C8C8CD;width:50px;height:0;float:left;margin:20px 0px 20px 5px;"></div>
</div>
<!--购买后显示-->
		...
		<!--会员规则-->
             <div class="fui-cell fui-sale-cell">
                    ...
                    <div class="fui-cell-text" style="white-space: inherit;">
                        <!-- <div>累计订单金额满158元享受会员折扣；满500元享受vip会员折扣</div> -->
                    </div>
                </div>
           <!--end-->

...
<div class='fui-page  fui-page-current'>
			...
			<div class="headinfo" style="z-index:100;border: none;">
				...
				<div class="child userinfo">
					<a href="<?php  echo mobileUrl('member/info')?>" data-nocache="true" style="color: white;">
						<div class="face"><img src="<?php  echo $member['avatar'];?>" onerror="this.src='https://benla.oss-cn-beijing.aliyuncs.com/static/images/noface.png'"/></div>
	...
	<?php  if($hascoupon) { ?>
		...
		<div class="fui-cell-group fui-cell-click">
			<a class="fui-cell" href="<?php  echo mobileUrl('commission')?>">
				<div class="fui-cell-icon"><i class="icon icon-fenxiao2"></i></div>
				<div class="fui-cell-text"><p>分销中心</p></div>
				<div class="fui-cell-remark"></div>
			</a>

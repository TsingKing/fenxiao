			...
			<div class="panel we7-panel account-stat">
				...
				<div class="panel-body we7-padding-vertical">
					<div class="col-sm-4 text-center">
						...
						<div class="num"><a href="<?php  echo url('system/module/not_installed', array('account_type' => 1))?>" class="color-default"><?php  echo $account_uninstall_modules_nums;?></a></div>
					</div>
					<div class="col-sm-4 text-center">
						<div class="title">可升级应用</div>
						<div class="num">{{upgrade_module_nums.account_upgrade_module_nums}}</div>
					</div>
					<div class="col-sm-4 text-center">
						<div class="title">应用总数</div>
						<div class="num"><a href="<?php  echo url('system/module/installed', array('account_type' => 1))?>" class="color-default"><?php  echo $account_modules_total;?></a></div>
					</div>
				</div>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="panel we7-panel account-stat">
				...
				<div class="panel-body we7-padding-vertical">
					<div class="col-sm-4 text-center">
						<div class="title">未安装应用</div>
						<div class="num"><a href="<?php  echo url('system/module/not_installed', array('account_type' => 4))?>" class="color-default"><?php  echo $wxapp_uninstall_modules_nums;?></a></div>
					</div>
					<div class="col-sm-4 text-center">
						<div class="title">可升级应用</div>
						<div class="num">{{upgrade_module_nums.wxapp_upgrade_module_nums}}</div>
					</div>
					<div class="col-sm-4 text-center">
						<div class="title">应用总数</div>
						<div class="num"><a href="<?php  echo url('system/module/installed', array('account_type' => 4))?>" class="color-default"><?php  echo $wxapp_modules_total;?></a></div>
					</div>
				</div>
			</div>
		</div>

...
<div class="navbar-collapse collapse" id="navbar">
    ...
    <ul class="nav navbar-top-links navbar-right">
        <li class="dropdown">
            ...
            <ul role="menu" class="dropdown-menu">
                ...
                <li class="divider"></li>
                <?php  if(p("grant")) { ?>
                <li><a href="<?php  echo webUrl('system/plugin/plugingrant')?>"><i class="icon icon-assessedbadge"></i> 应用授权</a></li>
                <?php  } ?>
                <li><a href="<?php  echo webUrl('system')?>"><i class="icon icon-settings"></i> 系统管理</a></li>
                <li><a href="<?php  echo webUrl('system/auth')?>"><i class="icon icon-down"></i> 系统更新</a></li>
                <?php  } ?>
    ...
    <ul class="nav navbar-nav    gray-bg">
        ...
        <li <?php  if($_W['current_menu']=='auth') { ?> class="active"<?php  } ?>><a href="<?php  echo webUrl('system/auth')?>">更新</a></li>
    </ul>

        ...
        <div class="seckill-title">
            <div class="seckill-text">
                ...
                <div class="killtime" style="color: <?php  echo $diyitem['style']['timecolor'];?>;" data-toggle="timer" data-status="<?php  echo $diyitem['data']['status'];?>" data-timer="<?php  echo $diyitem['data']['endtime'];?>|.time-hour|.time-min|.time-sec|<?php  echo $diyitem['data']['starttime'];?>">
                    ...
                    <?php  } else { ?>
                     <?php  } ?>
                    <span class="item time-hour" style="border-color:<?php  echo $diyitem['style']['timebordercolor'];?>;background-color: <?php  echo $diyitem['style']['timebgcolor'];?>;">--</span>
                    <span style="color: <?php  echo $diyitem['style']['timesigncolor'];?>;">:</span>
                    <span class="item time-min" style="border-color:<?php  echo $diyitem['style']['timebordercolor'];?>;background-color: <?php  echo $diyitem['style']['timebgcolor'];?>;">--</span>
                    <span style="color: <?php  echo $diyitem['style']['timesigncolor'];?>;">:</span>
                    <span class="item time-sec" style="border-color:<?php  echo $diyitem['style']['timebordercolor'];?>;background-color: <?php  echo $diyitem['style']['timebgcolor'];?>;">--</span>
                </div>
            </div>

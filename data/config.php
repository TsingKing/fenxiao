...
$config['db']['master']['password'] = 'pinlejia888';
$config['db']['master']['port'] = '3306';
$config['db']['master']['database'] = 'pinlejia';
...
$config['db']['slave']['1']['username'] = 'jiajiajia';
$config['db']['slave']['1']['password'] = 'jialejia888';
$config['db']['slave']['1']['port'] = '3306';
$config['db']['slave']['1']['database'] = 'test';

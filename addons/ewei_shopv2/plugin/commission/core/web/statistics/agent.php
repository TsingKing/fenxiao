...
class Agent_EweiShopV2Page extends PluginWebPage
{
	public function main()
	{
		...
		if ($_GPC['export'] == '1') {
			...
			$columns = array(
				...
				array('title' => '伙伴分销商总数', 'field' => 'levelcount', 'width' => 12),
				array('title' => '一级伙伴分销商数', 'field' => 'level1', 'width' => 12),
				array('title' => '二级伙伴分销商数', 'field' => 'level2', 'width' => 12),
				array('title' => '三级伙伴分销商数', 'field' => 'level3', 'width' => 12),
	...
	public function user()
	{
		...
		if ($_GPC['export'] == 1) {
			...
			m('excel')->export($list, array('title' => '推广伙伴-' . date('Y-m-d-H-i', time()), 'columns' => $columns));
		}

	...
	public function main() 
	{
		...
		else 
		{
			if (isset($options) && (0 < count($options)) && ($goods['hasoption'] !== 0)) 
			{
				...
				#2019-2-13 修复价格异常 pdo_query("delete from " . tablename("ewei_shop_goods_option") . " where goodsid=" . $id . ' and id not in ( ' . implode(',', $optionids) . ')');
			...
			{
				#2019-2-13 修复价格异常 pdo_query("delete from " . tablename("ewei_shop_goods_option") . " where goodsid=" . $id);
